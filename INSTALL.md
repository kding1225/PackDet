...
- tensorboardX, for visulization, need tensorflow installed
...
conda create -n PackDet
conda activate PackDet

# this installs the right pip and dependencies for the fresh python
conda install ipython

# PackDet and coco api dependencies
pip install ninja yacs cython matplotlib tqdm opencv-python scikit-image tensorboardX
...
cd $INSTALL_DIR
git clone https://github.com/kding1225/PackDet
cd PackDet
