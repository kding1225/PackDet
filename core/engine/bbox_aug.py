...
from core.modeling.rpn.fcos.inference import make_fcos_postprocessor
from core.modeling.rpn.packdet.inference2 import make_packdet_postprocessor2
...
def im_detect_bbox_aug(model, images, device):
    ...
    assert cfg.MODEL.FCOS_ON or cfg.MODEL.PACKDET_ON, \
        "The multi-scale testing only supports FCOS and PACKDET detector"
    ...
    elif cfg.MODEL.PACKDET_ON:
        post_processor = make_packdet_postprocessor2(cfg)
    else:
