...
from core.layers import smooth_l1_loss
...
from core.modeling.rpn.loss import RPNLossComputation
...
def make_retinanet_loss_evaluator(cfg, box_coder):
    matcher = Matcher(
        cfg.MODEL.RETINAPACK.FG_IOU_THRESHOLD,
        cfg.MODEL.RETINAPACK.BG_IOU_THRESHOLD,
        allow_low_quality_matches=True,
    )
    sigmoid_focal_loss = SigmoidFocalLoss(
        cfg.MODEL.RETINAPACK.LOSS_GAMMA,
        cfg.MODEL.RETINAPACK.LOSS_ALPHA
    )
    ...
    loss_evaluator = RetinaNetLossComputation(
        ...
        sigmoid_focal_loss,
        bbox_reg_beta = cfg.MODEL.RETINAPACK.BBOX_REG_BETA,
        regress_norm = cfg.MODEL.RETINAPACK.BBOX_REG_WEIGHT,
    )
