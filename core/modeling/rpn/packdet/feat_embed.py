...
class FEModule(torch.nn.Module):
    ...
    def __init__(self, cfg, in_channels):
        ...
        num_convs = cfg.MODEL.PACKDET.FE.NUM_CONVS
        self.out_channels = cfg.MODEL.PACKDET.FE.OUT_CHANNELS
...
class CgnFEModule(torch.nn.Module):
    ...
    def __init__(self, cfg, in_channels):
        ...
        num_convs = cfg.MODEL.PACKDET.CGN_FE.NUM_CONVS
        self.out_channels = cfg.MODEL.PACKDET.CGN_FE.OUT_CHANNELS
...
def build_feat_embed_layer(cfg, in_channels):
    feat_embed_type = cfg.MODEL.PACKDET.FE_TYPE
