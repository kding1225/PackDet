...
from core.utils.env import setup_environment  # noqa F401 isort:skip
...
from core.utils.comm import synchronize, \
...
from core.utils.tensorboardX import SummaryWriterX
from core.data.datasets.category import get_category
...
def run_test(cfg, model, distributed):
    ...
    for output_folder, dataset_name, data_loader_val in zip(output_folders, dataset_names, data_loaders_val):
        inference(
            ...
            cfg.MODEL.RETINANET_ON else cfg.MODEL.RPN_ONLY,
